...
public class Database {
    ...
    private void initializePurchaseSamples() {
        ...
        purchases.add(
                new Purchase("S002", "สมหญิง กรุณา", "Samsung S25 Ultra", "บัตรเครดิต", 42900, 1, 42900, "02/11/2024"));
        purchases.add(new Purchase("S003", "นายวีรศักดิ์ มั่นคง", "iPhone 17 Pro Max", "โอนเงิน", 48900, 1, 48900,
                "03/11/2024"));
    ...
    private void initializeRepairSamples() {
        repairs.add(new Repair("R001", "สมชาย ใจดี", "หน้าจอแตก", "iPhone 15 Pro", "Apple", "123456789012345", "ดำ",
                "0812345678", "หน้าจอแตกต้องเปลี่ยนใหม่", 2500, "01/11/2024"));
        repairs.add(new Repair("R002", "สมหญิง กรุณา", "แบตเตอรี่เสื่อม", "Samsung S24 Ultra", "Samsung",
                "234567890123456", "ขาว", "0898765432", "แบตเตอรี่หมดเร็ว ต้องเปลี่ยนใหม่", 1500, "02/11/2024"));
        repairs.add(new Repair("R003", "นายวีรศักดิ์ มั่นคง", "เสียบชาร์จไม่เข้า", "iPhone 14 Pro", "Apple",
                "345678901234567", "ทอง", "0825554444", "พอร์ตชาร์จเสีย ต้องซ่อม", 1200, "03/11/2024"));
    ...
    private void initializeReturnSamples() {
        returns.add(new Return("RT001", "S001", "สมชาย ใจดี", "iPhone 17 Pro", "สินค้ามีตำหนิ", "อนุมัติ", "01/11/2024",
                "อนุมัติการคืนเนื่องจากสินค้ามีตำหนิจากโรงงาน"));
        returns.add(new Return("RT002", "S002", "สมหญิง กรุณา", "Samsung S25 Ultra", "ไม่พอใจสินค้า", "รอดำเนินการ",
                "02/11/2024", ""));
        returns.add(new Return("RT003", "S003", "นายวีรศักดิ์ มั่นคง", "iPhone 17 Pro Max", "สั่งสินค้าผิด", "ปฏิเสธ",
                "03/11/2024", "ปฏิเสธเนื่องจากเกิน 7 วัน"));
    }

    // ⚠️ ตัวอย่างข้อมูลการเคลมสินค้า
    private void initializeClaimSamples() {
        claims.add(new Claim("CL001", "สมชาย ใจดี", "iPhone 17 Pro", "เครื่องเสียภายใน 7 วัน", "อนุมัติ", "01/11/2024",
                "อนุมัติเคลม เปลี่ยนเครื่องใหม่ให้"));
        claims.add(new Claim("CL002", "สมหญิง กรุณา", "Samsung S25 Ultra", "หน้าจอมีจุดดำ", "รอดำเนินการ", "02/11/2024",
                ""));
        claims.add(new Claim("CL003", "นายวีรศักดิ์ มั่นคง", "iPhone 17 Pro Max", "เครื่องร้อนผิดปกติ", "ปฏิเสธ",
                "03/11/2024", "ปฏิเสธเนื่องจากเป็นความเสียหายจากผู้ใช้"));
    }

    // 🚚 ตัวอย่างข้อมูลการจัดส่ง
    private void initializeDeliverySamples() {
        deliveries.add(new Delivery("S001", "KRY0000001", "สมชาย ใจดี", "123 ถนนสุขุมวิท กรุงเทพ", "0812345678",
                "Kerry Express", "จัดส่งสำเร็จ", "01/11/2024"));
        deliveries.add(new Delivery("S002", "FLS0000002", "สมหญิง กรุณา", "456 ถนนสีลม กรุงเทพ", "0898765432",
                "Flash Express", "อยู่ระหว่างขนส่ง", "02/11/2024"));
        deliveries.add(new Delivery("S003", "JNT0000003", "นายวีรศักดิ์ มั่นคง", "789 ถนนรัชดา กรุงเทพ", "0825554444",
                "J&T Express", "กำลังจัดส่ง", "03/11/2024"));
    ...
    private void initializeNotificationSamples() {
        // แจ้งเตือนพนักงาน
        notifications.add(new Notification("N001", "พนักงาน", "มีการคืนสินค้ารอดำเนินการจาก สมชาย ใจดี", "01/11/2024",
                "ยังไม่อ่าน"));
        notifications.add(
                new Notification("N002", "พนักงาน", "มีคำสั่งซื้อใหม่จาก สมหญิง กรุณา", "02/11/2024", "ยังไม่อ่าน"));
        notifications.add(new Notification("N003", "พนักงาน", "มีการเคลมสินค้ารอดำเนินการจาก นายวีรศักดิ์ มั่นคง",
                "03/11/2024", "ยังไม่อ่าน"));

        // แจ้งเตือนสมาชิก
        notifications.add(new Notification("N004", "สมาชิก", "การซ่อมของคุณพร้อมรับแล้ว", "01/11/2024", "ยังไม่อ่าน"));
        notifications
                .add(new Notification("N005", "สมาชิก", "คำสั่งซื้อของคุณกำลังจัดส่ง", "02/11/2024", "ยังไม่อ่าน"));
        notifications.add(
                new Notification("N006", "สมาชิก", "การคืนสินค้าของคุณได้รับการอนุมัติ", "03/11/2024", "ยังไม่อ่าน"));
    }
    ...
    public void addDelivery(String purchaseId, String customerName, String address, String phone,
        ...
        deliveries.add(
                new Delivery(purchaseId, trackingNumber, customerName, address, phone, deliveryCompany, status, date));
    ...
    public static class Delivery {
        ...
        @Override
        public String toString() {
            return String.format("เลข tracknumber : %s | ลูกค้า: %s | บริษัท: %s | สถานะ: %s",
